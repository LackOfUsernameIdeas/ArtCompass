...
import gradientDark from "../../../assets/images/brand-logos/layered-peaks-haikei-dark.svg";
import gradientLight from "../../../assets/images/brand-logos/layered-peaks-haikei-light.svg";
