        ...
        <div className="xxl:col-span-7 xl:col-span-7 lg:col-span-12 col-span-12">
          <div className="flex justify-center items-center h-full">
            ...
            <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
              ...
              <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 ml-[1.5rem] mt-0 md:mt-10">
        ...
        <InfoboxModal
          ...
          description={
            <>
              ...
              <p>
                АртКомпас е лицензиран на Вас (Краен потребител) за ползване
                само в съответствие с условията на това Споразумение за лиценз.
              </p>
              <p>
                Чрез достъпа до уеб приложението АртКомпас, Вие потвърждавате,
                че сте съгласни да бъдете обвързани от всички условия и
                разпоредби на това Споразумение за лиценз и че приемате това
              ...
              <ul>
                <li>
                  ...
                  несублицензируем лиценз да използвате уеб приложението
                  АртКомпас за лична, некомерсиална употреба.
                </li>
                <li>
                  1.2 Вие не можете да споделяте или да правите уеб приложението
                  достъпно за трети страни, да продавате, наемате, заемате,
                  давате под наем или по друг начин да разпределяте уеб
                  приложението.
                </li>
                <li>
                  1.3 Вие не можете да извършвате обратен инженеринг,
                  декомпилиране или да се опитвате да възстановите изходния код
                  на уеб приложението или неговите компоненти.
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  2.2 Данните се използват единствено с цел подобряване на
                  Вашето преживяване в платформата и няма да бъдат разкривани на
                  трети страни без Вашето изрично съгласие.
                </li>
                <li>
              ...
              <ul>
                <li>
                  ...
                  Лицензодателят не носи отговорност за каквито и да е
                  специални, инцидентни, косвени или последващи щети,
                  произтичащи от или свързани с използването или невъзможността
                  за използване на уеб приложението АртКомпас.
                </li>
              </ul>
              ...
              <ul>
                <li>
                  5.1 Лицензодателят си запазва правото да изменя или
                  актуализира условията на това Споразумение по всяко време.
                </li>
                <li>
                ...
                <li>
                  5.3 Продължаващото използване на уеб приложението АртКомпас
                  след такива изменения ще се счита за приемане на новите
                  условия.
                </li>
              </ul>
